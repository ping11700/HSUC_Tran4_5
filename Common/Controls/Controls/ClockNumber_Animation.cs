...
namespace Common.Controls
{
    ...
    public class ClockNumber_Animation : Viewport3D
    {
        ...
        public static readonly DependencyProperty CornerRadiusProperty = DependencyProperty.Register(
            "CornerRadius", typeof(CornerRadius), typeof(ClockNumber_Animation), new PropertyMetadata(new CornerRadius(4)));
        ...
        public static readonly DependencyProperty BackgroundProperty = DependencyProperty.Register(
            "Background", typeof(Brush), typeof(ClockNumber_Animation), new PropertyMetadata(default(Brush)));
        ...
        public static readonly DependencyProperty ForegroundProperty = DependencyProperty.Register(
            "Foreground", typeof(Brush), typeof(ClockNumber_Animation), new PropertyMetadata(default(Brush)));
        ...
        public static readonly DependencyProperty FontSizeProperty = DependencyProperty.Register(
            "FontSize", typeof(double), typeof(ClockNumber_Animation), new PropertyMetadata(70.0));
        ...
        public static readonly DependencyProperty NumberProperty = DependencyProperty.Register(
            "Number", typeof(int), typeof(ClockNumber_Animation), new PropertyMetadata(ValueBoxes.Int0Box, OnNumberChanged));

        private static void OnNumberChanged(DependencyObject s, DependencyPropertyChangedEventArgs e) =>
            ((ClockNumber_Animation)s).OnNumberChanged();
