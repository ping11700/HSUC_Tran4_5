using Common.AttachedPproperty;
...
namespace Common.Controls
{
    ...
    public class Drawer : FrameworkElement
    {
        ...
        private void OnIsOpenChanged(bool isOpen)
        {
            ...
            _window = WindowAPI.GetActiveWindow()?? Application.Current.MainWindow;
            ...
            var decorator = VisualHelper<AdornerDecorator>.FindChild(_window);
