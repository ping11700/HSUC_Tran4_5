...
namespace Common.AttachedPproperty
{
    public class TextInfoElement : TitleElement
    {
        /// <summary>
        ///     水印
        /// </summary>
        public static readonly DependencyProperty WatermarkProperty = DependencyProperty.RegisterAttached(
            "Watermark", typeof(string), typeof(TextInfoElement), new FrameworkPropertyMetadata(default(string), FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty NecessaryProperty = DependencyProperty.RegisterAttached(
            "Necessary", typeof(bool), typeof(TextInfoElement), new FrameworkPropertyMetadata(ValueBoxes.FalseBox, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty SymbolProperty = DependencyProperty.RegisterAttached(
            "Symbol", typeof(string), typeof(TextInfoElement), new FrameworkPropertyMetadata(default(string), FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty ContentHeightProperty = DependencyProperty.RegisterAttached(
            "ContentHeight", typeof(double), typeof(TextInfoElement), new FrameworkPropertyMetadata(30.0, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty MinContentHeightProperty = DependencyProperty.RegisterAttached(
            "MinContentHeight", typeof(double), typeof(TextInfoElement), new PropertyMetadata(30.0));
        ...
        public static readonly DependencyProperty MaxContentHeightProperty = DependencyProperty.RegisterAttached(
            "MaxContentHeight", typeof(double), typeof(TextInfoElement), new PropertyMetadata(double.PositiveInfinity));
        ...
        public static readonly DependencyProperty RegexPatternProperty = DependencyProperty.RegisterAttached(
            "RegexPattern", typeof(string), typeof(TextInfoElement), new PropertyMetadata(default(string)));
